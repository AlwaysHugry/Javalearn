...
import java.io.*;
import java.net.*;
public class Test6 extends JFrame implements MouseListener {
    ...
    public Test6(String title, String host, int port1, int port2) {
   ...
   @Override
    ...
    public static void main(String[] args) {
        ...
        Test6 app1 = new Test6("角色1", "localhost", 8888, 9999);

        app1.setDefaultCloseOperation(EXIT_ON_CLOSE);

        Test6 app2 = new Test6("角色2", "localhost", 9999, 8888);
